class CoinsController < ApplicationController
  ...
  # 1 = nome do método, 2 = onde/quando (que médoto for chamado) deve aparecer 
  before_action :set_mining_type_options, only: [:new, :update, :create, :edit]
  ...
  private
    # Set mining types for further choise
    # Método privado, será invocada antes, aqui no controler com um "before_action" para estar disponível só o que desejamos
